...
<head>
    ...
    <meta property="og:title" content="Seach">
    <meta name="twitter:description" content="">
    <meta name="twitter:title" content="Seach">
    <title>Search</title>
    ...
    <!--  -->
        ...
        <div class="row title-pages-aboutus">
            <div class="jumbotron d-flex align-items-center">
                <div class="container">
                    <h1 class="display-4" style="font-size: 35px">Results for "{{$key}}"</h1>
                </div>
            </div>
        </div>
        ...
        <div class="row" style="background-color: #fcfbfa">
            <div class="col-md-12 d-flex justify-content-center">
                {{ $listSearch->links('pagination::bootstrap-4') }}
            </div>
        </div>
        <!--  -->
        <x-footer/>
